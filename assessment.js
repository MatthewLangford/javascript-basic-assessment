...
//myShirt['type'] = 'spandex'; // this wouldn't work in spec runner
...
// Jeremy and then changes the person object to have a property called lovesCode with a value of 10.  If their name is Brack set lovesCode to 0.  otherwise set lovesCode to 5.
...
// cloudiness(number), in that order. Using the following to return the correct values
/*
...
// #16 Create a function called callerBack that takes in a function (holla) and a string parameter(back) and invokes it(holla) with
// the argument string(back) + ' back'."
